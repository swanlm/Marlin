...
#define STRING_CONFIG_H_AUTHOR "(swanlm, Ender-5-SKR-mini-E3-V2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Wiggin-5"
...
#define DEFAULT_bedKp 191.42
#define DEFAULT_bedKi 31.01
#define DEFAULT_bedKd 787.67
